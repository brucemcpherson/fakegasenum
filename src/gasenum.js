 ...
 * @return {CircularEnum}
 */
export const newFakeGasenum = (keys, defaultKey) => makeCircularEnum(false , keys, defaultKey)
export const newFakeGasenumSafe = (keys, defaultKey) => makeCircularEnum(true , keys, defaultKey)